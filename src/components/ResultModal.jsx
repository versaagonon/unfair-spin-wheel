      ...
      >
        ...
        <div className="p-10 flex flex-col items-center text-center">
          ...
          <div className="space-y-2 mb-10">
            <span className="text-accent-primary font-bold text-[10px] uppercase tracking-[0.2em]">Pemenang Undian</span>
          ...
          <div className="w-full flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5 mb-10">
            ...
            <div className="flex-1 text-right">
              <p className="text-text-dim text-[10px] font-bold uppercase tracking-widest">Urutan</p>
